  ...
  handler: async (ctx) => {
      ...
      const initialMemorials = [
        {
          ...
          links: [
            { label: "National War Memorial Entry", url: "https://nationalwarmemorial.gov.in" },
            { label: "MHA Gallantry Citation", url: "https://www.gallantryawards.gov.in" }
          ]
        },
        {
          id: "vikram-batra",
          ...
          writeUp: "Leading from the front at 17,000 feet in the Kargil heights, Captain Batra recaptured Point 5140 in hand-to-hand combat. Later, during the assault on Point 4875, he fearlessly exposed himself to heavy enemy machine gun fire to rescue an injured junior officer, laying down his life with unmatched valor.",
          salutesCount: 2026,
          citations: [
          ...
          links: [
            { label: "Param Vir Chakra Citation", url: "https://www.gallantryawards.gov.in" }
          ]
        },
        {
          id: "mohit-sharma",
          ...
          links: [
            { label: "Special Forces Roll of Honor", url: "https://indianarmy.nic.in" }
          ]
        },
        {
          id: "santosh-babu",
          ...
          writeUp: "Commanding Officer of 16 Bihar, Col Santosh Babu led his troops with exemplary calm and indomitable courage during the Galwan Valley confrontation, holding Indian sovereign territory resolutely until making the supreme sacrifice.",
          salutesCount: 1857,
          citations: [
          ...
          links: [
            { label: "Galwan Bravehearts Memorial", url: "https://nationalwarmemorial.gov.in" }
          ]
        }
      ];
    ...
    if (existingFeed.length === 0) {
      await ctx.db.insert("opsFeed", {
        ...
        detail: "Real-time tactical network active. UAPA threat intelligence loaded.",
        timestamp: Date.now(),
      });
    }
